...
Route::middleware(['auth', 'must-change-password'])->group(function () {Route::get('/home', [ App\Http\Controllers\HomeController::class, 'index', ])->name('home');
...
Route::get('timetable/{id}/download', [ App\Http\Controllers\LandingController::class,'download',])->name('timetable.download');
